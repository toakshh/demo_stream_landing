...
const communityStats = [
  {
    ...
    number: "25,000+",
    label: "Developers",
    description: "Active developers building with Ready Player Me"
  },
  {
    icon: <MessageCircle className="w-8 h-8" />,
    number: "50M+",
    label: "Avatars Created",
    description: "Avatars generated across all platforms"
  },
  {
    icon: <BookOpen className="w-8 h-8" />,
    number: "1,000+",
    label: "Games Integrated",
    description: "Games and apps using our technology"
  },
  {
    icon: <Github className="w-8 h-8" />,
    number: "100+",
    label: "Open Source",
    description: "Community contributions and tools"
  }
]
...
export default function CommunitySection() {
  return (
    <section 
      ...
      style={{
        background: "radial-gradient(48.62% 45.53% at 118.91% 41.61%, #6542FF 0%, #000 100%), radial-gradient(43.82% 47.01% at -22.63% 51.19%, #6542FF 0%, #000 100%)",
      ...
      <div className="container m-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/80 max-w-3xl mx-auto font-montreal">
            Connect with thousands of developers building the future of gaming
          </p>
        </div>
          ...
          {communityStats.map((stat, index) => (
            <div key={index} className="text-center group">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-white/20 transition-all duration-300 hover:transform hover:scale-105">
                <div className="flex justify-center mb-4 text-white group-hover:text-[#6542FF] transition-colors">
                  {stat.icon}
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-black/40 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
            ...
            <p className="text-white/80 mb-6 font-montreal">
              Get help, share ideas, and connect with other developers in our active community forum.
            </p>
            <ul className="space-y-3 mb-6">
              <li className="flex items-center text-white/80 text-sm">
                <div className="w-2 h-2 bg-[#6542FF] rounded-full mr-3 flex-shrink-0" />
                <span className="font-montreal">Technical support</span>
              </li>
              <li className="flex items-center text-white/80 text-sm">
                <div className="w-2 h-2 bg-[#6542FF] rounded-full mr-3 flex-shrink-0" />
                <span className="font-montreal">Feature discussions</span>
              </li>
              <li className="flex items-center text-white/80 text-sm">
                <div className="w-2 h-2 bg-[#6542FF] rounded-full mr-3 flex-shrink-0" />
                <span className="font-montreal">Community showcases</span>
              </li>
            </ul>
            <button className="w-full px-6 py-3 bg-white text-[#6542FF] rounded-lg font-medium hover:bg-gray-100 transition-colors">
              Join Forum
            </button>
          </div>
